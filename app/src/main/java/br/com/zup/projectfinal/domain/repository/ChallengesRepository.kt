...
class ChallengesRepository {
    ...
    val listofchallenges = mutableListOf<ChallengeModel>()
        ...
        listofchallenges.add(ChallengeModel(challengeName = "Assista um vídeo engraçado", challengePoints = 10))
        listofchallenges.add(ChallengeModel(challengeName = "Faça uma refeição saudável", challengePoints = 30))
        listofchallenges.add(ChallengeModel(challengeName = "Dê uma volta em seu bairro", challengePoints = 60))
        listofchallenges.add(ChallengeModel(challengeName = "Marque nutricionista", challengePoints = 80))
        listofchallenges.add(ChallengeModel(challengeName = "Tire um tempo de lazer", challengePoints = 60))
        listofchallenges.add(ChallengeModel(challengeName = "Priorize sua saúde mental", challengePoints = 100))
        listofchallenges.add(ChallengeModel(challengeName = "Pratique atividade física", challengePoints = 50))
        listofchallenges.add(ChallengeModel(challengeName = "Não pule refeições", challengePoints = 40))
        listofchallenges.add(ChallengeModel(challengeName = "Faça pausas regulares", challengePoints = 60))
