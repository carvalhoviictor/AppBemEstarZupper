...
class ChallengesRepository {
    ...
    val listofchallenges = mutableListOf<ChallengeModel>()
        ...
        listofchallenges.add(ChallengeModel(challengeName = "Reduza o consumo de\nalimentos industrializados\ne de fast food", challengePoints = 100))
